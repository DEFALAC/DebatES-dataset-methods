...
def generate_claims(client, segments_csv, output_txt, log_folder, call_count, start_time):
    """Processes the segments CSV file and generates claims.
    Args:
...
if __name__ == "__main__":
    with open("prompts/system_prompt_claims.txt", "r", encoding="utf-8") as f:
    ...
    OUTPUT_TXTs = [
        "annotations/claims/1993-05-24.txt",
        "annotations/claims/2008-02-25.txt",
        "annotations/claims/2008-03-03.txt",
        "annotations/claims/2011-11-07.txt",
        "annotations/claims/2015-11-23.txt",
        "annotations/claims/2015-11-30.txt",
        "annotations/claims/2015-12-14.txt",
        "annotations/claims/2016-06-13.txt",
        "annotations/claims/2019-04-16.txt",
        "annotations/claims/2019-04-20.txt",
        "annotations/claims/2019-04-22.txt",
        "annotations/claims/2019-04-23.txt",
        "annotations/claims/2019-11-01.txt",
        "annotations/claims/2019-11-02.txt",
        "annotations/claims/2019-11-04.txt",
        "annotations/claims/2019-11-07.txt",
        "annotations/claims/2023-07-10.txt",
        "annotations/claims/2023-07-13.txt",
        "annotations/claims/2023-07-19.txt"        
    ]
    ...
    for SEGMENTS_CSV, OUTPUT_TXT in zip(SEGMENTS_CSVs, OUTPUT_TXTs):
        ...
        call_count, start_time = generate_claims(client, SEGMENTS_CSV, OUTPUT_TXT, LOG_FOLDER, call_count, start_time)
