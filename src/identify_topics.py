...
def generate_topics(client, segments_csv, output_txt, log_folder, call_count, start_time):
    """Processes the segments CSV file and generates a topic for each intervention.
    Args:
    ...
    with open(segments_csv, "r", encoding="utf-8") as segments_file:
        ...
        segments = [(row['inicio'], row['nombre'], row['texto']) for row in reader]

    segments_text = "\n".join([f'[{segment[0]}] ({segment[1]}) {segment[2]}' for segment in segments])
        
    response, call_count, start_time = rate_limited_api_call(client, segments_text, 0, 0, log_folder, max_calls=2)
...
if __name__ == "__main__":
    with open("prompts/system_prompt_topics.txt", "r", encoding="utf-8") as f:
    ...
    OUTPUT_TXTs = [
        "annotations/topics/1993-05-24.txt",
        "annotations/topics/2008-02-25.txt",
        "annotations/topics/2008-03-03.txt",
        "annotations/topics/2011-11-07.txt",
        "annotations/topics/2015-11-23.txt",
        "annotations/topics/2015-11-30.txt",
        "annotations/topics/2015-12-14.txt",
        "annotations/topics/2016-06-13.txt",
        "annotations/topics/2019-04-16.txt",
        "annotations/topics/2019-04-20.txt",
        "annotations/topics/2019-04-22.txt",
        "annotations/topics/2019-04-23.txt",
        "annotations/topics/2019-11-01.txt",
        "annotations/topics/2019-11-02.txt",
        "annotations/topics/2019-11-04.txt",
        "annotations/topics/2019-11-07.txt",
        "annotations/topics/2023-07-10.txt",
        "annotations/topics/2023-07-13.txt",
        "annotations/topics/2023-07-19.txt"        
    ]
    ...
    for SEGMENTS_CSV, OUTPUT_TXT in zip(SEGMENTS_CSVs, OUTPUT_TXTs):
        ...
        call_count, start_time = generate_topics(client, SEGMENTS_CSV, OUTPUT_TXT, LOG_FOLDER, call_count, start_time)
