...
def generate_proposals(client, segments_csv, output_txt, log_folder, call_count, start_time):
    """Processes the segments CSV file and generates proposals.
    Args:
...
if __name__ == "__main__":
    with open("prompts/system_prompt_proposals.txt", "r", encoding="utf-8") as f:
    ...
    OUTPUT_TXTs = [
        "annotations/proposals/1993-05-24.txt",
        "annotations/proposals/2008-02-25.txt",
        "annotations/proposals/2008-03-03.txt",
        "annotations/proposals/2011-11-07.txt",
        "annotations/proposals/2015-11-23.txt",
        "annotations/proposals/2015-11-30.txt",
        "annotations/proposals/2015-12-14.txt",
        "annotations/proposals/2016-06-13.txt",
        "annotations/proposals/2019-04-16.txt",
        "annotations/proposals/2019-04-20.txt",
        "annotations/proposals/2019-04-22.txt",
        "annotations/proposals/2019-04-23.txt",
        "annotations/proposals/2019-11-01.txt",
        "annotations/proposals/2019-11-02.txt",
        "annotations/proposals/2019-11-04.txt",
        "annotations/proposals/2019-11-07.txt",
        "annotations/proposals/2023-07-10.txt",
        "annotations/proposals/2023-07-13.txt",
        "annotations/proposals/2023-07-19.txt"        
    ]
    ...
    for SEGMENTS_CSV, OUTPUT_TXT in zip(SEGMENTS_CSVs, OUTPUT_TXTs):
        ...
        call_count, start_time = generate_proposals(client, SEGMENTS_CSV, OUTPUT_TXT, LOG_FOLDER, call_count, start_time)
